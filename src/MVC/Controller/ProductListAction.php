<?php
/**
 * To view all product in the system
...
class ProductListAction extends AbstractAction
{
    /**
    ...
    {
        $this->tpl->title       = 'View Product List | The Wak MiniCart';
        $this->tpl->description = 'This is the Product list page';
    }
    ...
    private function showProductList()
    {
        ...
        $record_count = ProductsDal::getProductsCount($this->container);
        if ($record_count == -1) {
            $this->tpl->productList = null;
        } else {
            ...
            $this->tpl->productList     = ProductsDal::getProductList($this->container, $paginator->getOffset(), $page_display_size);
        }
    }
}
